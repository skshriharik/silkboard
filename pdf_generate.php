...
$mobile = 5346959289;
$ack_number = 44654;
$connect= mysqli_connect('localhost', 'root', 'root', 'regwebappn');
$query="SELECT * FROM pdetails p,plot t WHERE p.mobile = t.mobile and t.ack_number = '$ack_number'";
...
$pdf->SetFont('Times','',14);
$pdf->Cell(50,9,$row['landline'],1,1);
$pdf->SetFont('Arial','',10);
...
$pdf->SetFont('Times','',14);
$add=" $row[addr] , $row[district] District, $row[state] State.";
...
$pdf->SetFont('Times','B',14);
$pdf->Cell(90,9,'transaction Id:',1,0);
$pdf->SetFont('Times','',14);
$pdf->Cell(90,9,$row['transaction_id'],1,1);
...
$pdf->SetFont('Times','',14);
$pdf->multiCell(140,9,$row['other_details'],0,1);
$pdf->Ln(30);
