    		...
    		<div class="wrap-contact100">
    			...
    			<form name="contact-form" action="try.php" method="post" id="contact-form" class="contact100-form validate-form">
    				<div class="wrap-input100 validate-input" data-validate="Name is required">
    					<span class="label-input100">Full Name:<br>(Example:<br>Srujan K S)</span>
    					<input class="input100" type="text" name="first_name" placeholder="Enter full name">
    					<span class="focus-input100"></span>

    				</div>

    				<div class="wrap-input100">
    					<span class="label-input101">Father/Husband Name:</span><input class="input100" type="text" name="middle_name" placeholder="Enter name ">
    					<span class="focus-input100"></span>
    				</div>
    			...
    			<div class="wrap-input100 validate-input" data-validate = "Address is required">
    				...
    				<div class="wrap-input101" data-validate = "Address is required">
    					...
    					<div class="container-contact100-form-btn">
    						<div class="n1">
    					<button class="contact100-form-btn" name="clear" onclick="myFunction()">
    						<span>
    					...
    					<div class="n2">
    					<button class="contact100-form-btn" id="next_form" type="submit" name="one">
    						<span>
    							Next
